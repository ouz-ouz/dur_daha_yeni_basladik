...
import 'package:mhp_app/scenes/settings.dart';
import 'package:mhp_app/scenes/turkes/alparslan_turkes.dart';
...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: new Container( //Seçilen sayfayı döndürür body kısmında ekrana basar
        child: Selector(_selectedIndex),
      ),

      bottomNavigationBar: BottomNavigationBar( // Alt Menü
